...
export const RepositorySelector: React.FC<RepositorySelectorProps> = ({ onRepositorySelect }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-white mb-4">Select Repository</h2>
        <p className="text-gray-300">Choose a repository to generate a comprehensive README file.</p>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-gray-700 text-white rounded-lg border border-gray-600 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
          </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {filteredRepos.map((repo) => (
          <div
            ...
            className="bg-gray-800 p-6 rounded-xl border border-gray-700 hover:border-gray-600 hover:bg-gray-750 transition-all cursor-pointer group transform hover:-translate-y-1 hover:shadow-xl"
          >
